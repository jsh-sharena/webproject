/*!
 * pbp | v3.0.10
 * 12/24/2019, 11:42:40 AM
 * wushiyang <wushiyang@bilibili.com>, lipengcheng <lipengcheng@bilibili.com>, tangjunxing <tangjunxing@bilibili.com>
 */
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):(e=e||self).BiliPBP=t()}(this,function(){"use strict";function l(e){return(l="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function a(e,t){for(var i=0;i<t.length;i++){var a=t[i];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function e(e,t,i){return t&&a(e.prototype,t),i&&a(e,i),e}function r(s){return new Promise(function e(t,i){if(s.url){var a=new XMLHttpRequest;s.pending&&(s.pending.xhr=a);var r=s.url;if(s.params){var n=Object.keys(s.params).map(function(e){return encodeURIComponent(e)+"="+encodeURIComponent(s.params[e])}).join("&");if(!(r=function(e,t){var i=e.split("?");if(2===i.length)i[1]?e+="&"+t:e+=t;else{if(1!==i.length)return"";e+="?"+t}return e}(r,n)))return void i(new Error("xhr url parse error"))}for(var o in s.method||(s.method="GET"),a.open(s.method.toUpperCase(),r,!0),s.withCredentials&&(a.withCredentials=!0),s.responseType?a.responseText=s.responseType:a.responseType="text",a.onreadystatechange=function(){4===a.readyState&&(200<=a.status&&a.status<300?t(function(e,t){if("json"===t){var i,a=e.responseText;try{i=JSON.parse(a)}catch(e){i={}}return i}}(a,"json")):s.retry&&"number"==typeof s.retry&&!s.pending.manualPause?(s.retry-=1,function(a){return new Promise(function(e,t){var i=setTimeout(e,2e3);a.stopTimer=function(){clearInterval(i),i=null,a.stopTimer=null,t(new Error("stop timer"))}})}(s.pending).then(function(){s.retryFunction&&"function"==typeof s.retryFunction&&s.retryFunction(),e(t,i)}).catch(i)):i({http_url:r,http_method:s.method,http_status:a.status}))},s.headers)s.headers.hasOwnProperty(o)&&a.setRequestHeader(o,s.headers[o]);"object"===l(s.data)&&(a.setRequestHeader("Content-Type","application/json; charset=UTF-8"),s.data=JSON.stringify(s.data)),a.send(s.data||null)}else i(new Error("xhr url missing"))})}var n=function(e,t,i,a){return r({url:"//".concat(i||"api.bilibili.com","/pbp/data?cid=").concat(t,"&version=").concat(a),method:"get",withCredentials:!0})},o=function(){function t(e){i(this,t),this.isRunning=!1,this.recIsFirst=!0,this.recHasOpen=!1,this.recListFooterWatcher=null,this.debug=!1}return e(t,[{key:"_init",value:function(){var a=this;if(window.$pbp&&window.$pbp.aid){var e,t,r;window.recLoader&&this.recIsFirst&&(window.recLoader=this),NodeList.prototype.forEach=Array.prototype.forEach;var n=location.href.indexOf("/av");if(-1==n){if(!(e=document.getElementById("recom_module")))return;t=e.querySelector(".recom-list"),r=t.querySelectorAll(".recom-item")}else{if(!(e=document.getElementById("reco_list")))return;t=e.querySelector(".rec-list"),r=t.querySelectorAll(".video-page-card")}this.recIsFirst&&(this.recListFooterWatcher=new MutationObserver(function(){a.isRunning=!0,setTimeout(a._init.bind(window.recLoader),0)}),this.recListFooterWatcher.observe(t,{childList:!0,subtree:!1})),r.forEach(function(e,t,i){a.recIsFirst||20===r.length?-1===n?a._recListLoadDrawer(e.querySelector(".cover-wrapper"),e.querySelector("a")?e.querySelector("a").href:null):a._recListLoadDrawer(e.querySelector(".pic")):19<t&&(-1===n?a._recListLoadDrawer(e.querySelector(".cover-wrapper"),e.querySelector("a")?e.querySelector("a").href:null):a._recListLoadDrawer(e.querySelector(".pic"))),!e.nextElementSibling&&a.recIsFirst?a.recIsFirst=!1:e.nextElementSibling||(a.recHasOpen=!0)}),setTimeout(function(){a.isRunning=!1},0)}}},{key:"_recListLoadDrawer",value:function(e,t){if(e&&!e.querySelector(".rec-list-item-load")){var i,a=-1===location.href.indexOf("/av")?t:e.querySelector("a").href,r=a.slice(a.indexOf("/av")+3,-1===location.href.indexOf("/av")?a.lastIndexOf("/"):a.indexOf("?")-1);if(a){var n=[];try{var o=window.wsLocalStorage.get("pbp_rec_loader_"+r);o&&(n=JSON.parse(window.wsLocalStorage.get("pbp_zebra_cache_"+o)))}catch(e){return}finally{if(null==n||0===n.length)return;if(0==(i=n[n.length-1][1]))return;window.BiliPBP.prototype._debugLog.call(this,r+"Injected");var s=document.createElement("div");s.setAttribute("class","rec-list-item-load"),s.style.background="gray",s.style.display="block",s.style.position="absolute",s.style.top="76px",s.style.width="100%",s.style.height="4px",s.style.zIndex="2";var l=document.createElement("span");l.setAttribute("class","rec-list-item-loaded"),l.style.background="#fb7299",l.style.position="absolute",l.style.height="4px",l.style.width=100*i+"%",s.appendChild(l),e.appendChild(s)}}}}}]),t}();function s(e,t){var i=localStorage.getItem(e);return null==i&&c(e,t),i||t}var t,p=(function(e,t){
/*!
